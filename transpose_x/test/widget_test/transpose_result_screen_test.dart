...
void main() {
  ...
  testWidgets(
    'TransposeResultScreen renders without crashing (ignoring overflow)',
    (tester) async {
      ...
      expect(find.text('Download XML'), findsOneWidget);
      expect(find.text('Share XML'), findsOneWidget);
  ...
  testWidgets(
    'Tapping Save to Library shows input dialog (suppress overflow)',
